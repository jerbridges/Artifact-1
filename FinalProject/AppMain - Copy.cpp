...
int main(void)
{
	...
	GLfloat lampVertices[] = {
		-0.05, -0.75, 0.0,	// index 0
		0.05, -0.75, 0.0,	// index 1
		-0.05, 0.5, 0.0,	// index 2
		0.05, 0.5, 0.0,		// index 3
};
	...
	glm::vec3 planePositions[] = {
		glm::vec3(0.5f,  0.0f,  0.25f),	// outsdie plane
		glm::vec3(0.45f, 0.0f,  0.2f),		// right plane
		glm::vec3(0.5f,  0.0f,  0.15f),	// inside plane
		glm::vec3(0.55f, 0.0f,  0.2f)		// left plane
	};

/*	glm::vec3 planePositions2[] = {
		glm::vec3(0.5f, 0.0f,  0.25f), // front plane
		glm::vec3(0.55f, 0.0f, 0.2f), // Right Plane
		glm::vec3(0.5f, 0.0f,  0.15f), // Back Plane
		glm::vec3(0.45f, 0.0f, 0.2f)  // Left Plane
	};

	glm::vec3 planePositions3[] = {
		glm::vec3(-0.5f,  0.0f,  -0.15f), // front plane
		glm::vec3(-0.45f,  0.0f, -0.2f), // Right Plane
		glm::vec3(-0.5f,  0.0f,  -0.25f), // Back Plane
		glm::vec3(-0.55f, 0.0f,  -0.2f)  // Left Plane
	};
...
//	glm::float32 planeRotations[] = {0.0f, 90.0f, 0.0f, 90.0f};


	//seat translation
	glm::vec3 seatTranslation[] = {
		glm::vec3(-0.125f, 0.6f, 0.f), // top of seat
		glm::vec3(0.125f, 0.5f, 0.f), // bottom of seat
		glm::vec3(-0.125f, 0.55f, -0.25f), // back of seat
		glm::vec3(-0.125f, 0.55f, 0.25f), // front of seat
		glm::vec3(-0.625f, 0.55f, 0.05f), // left side of seat
		glm::vec3(0.625f, 0.55f, 0.05f), // right of seat
	};

	// seat rotations
	glm::float32 seatRotationAngle[] = {
		-90.0f, 90.0f, 0.0f, 0.0f, 90.0f, 90.0f
	};

	//seat rotation
	glm::vec3 seatRotation[] = {
	...
	//seat scale
	glm::vec3 seatScale[] = {
		glm::vec3(5.f, 1.f, 5.f), // top of seat
		glm::vec3(5.f, 1.f, 5.f), // bottom of seat
		glm::vec3(1.f, 1.f, 1.f), // back of seat
		glm::vec3(1.f, 1.f, 1.f), // front of seat
		glm::vec3(1.f, 0.4f, 1.f), // left side of seat
		glm::vec3(1.f, 0.4f, 1.f), // right of seat

	};

	
	glm::vec3 footTranslation[] = {
		glm::vec3(-0.088f, 0.465f, 0.25f),  //front
		glm::vec3(-0.088f, 0.465f, 0.15f),	//back
		glm::vec3(-0.088f, 0.5f, 0.2f),	//top
		glm::vec3(-0.088f, 0.425f, 0.2f),	//bottom
	};

	glm::vec3 footTranslation2[] = {
		glm::vec3(-0.55f, 0.465f, 0.03f),  //front
		glm::vec3(-0.45f, 0.465f, 0.03f),	//back
		glm::vec3(-0.5f,  0.5f, 0.03f),	//top
		glm::vec3(-0.5f,  0.425f, 0.03f),	//bottom
	};
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(seatVAO);
			for (GLuint i = 0; i < 6; i++)
			{
				...
				modelMatrix = glm::rotate(modelMatrix, 90.f * toRadians, seatRotation[i]);
				modelMatrix = glm::rotate(modelMatrix, seatRotationAngle[i] * toRadians, seatRotation2[i]);
		...
		//select and transform foot rests
			...
			for (GLuint i = 0; i < 4; i++)
			{
				...
				glm::mat4 modelMatrix;
				modelMatrix = glm::translate(modelMatrix, footTranslation[i]);
